...
public class easySearch {
	...
	public static final String INDEX_DIR_PATH = "/Users/bharvadl/Downloads/index";
			...
			for (LeafReaderContext leafReaderContext : leafReaderContexts) {
				...
				if (posting != null) {
					while (posting.nextDoc() != PostingsEnum.NO_MORE_DOCS) {
						...
						queryTermScore.addDocScore(docNO, relevanceScoreForTerm);
						queryScore.addRelDoc(docNO);
					}
				}
			}
	...
	public static void main(String[] args) {
		try {
			...
			for (String docNo : queryScore.relDocId) {
				System.out.println("Document ID: " + docNo + "  Score:" + queryScore.getDocScore(docNo));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
